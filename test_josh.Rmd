...
server <- function(input, output, session) {
    ...
    # Here is the histogram plot. It allows for user to compare two boroughs, compare a borough with a neighborhood, compare two neighborhoods. It also prevents output where there are less than ten data points for either histogram.
